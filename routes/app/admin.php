...
use App\Http\Controllers\Admin\AssignPenilaiAllController;
...
Route::group(['domain' => ''], function () {
    ...
    Route::prefix('admin/')->name('admin.')->group(function () {
        ...
        Route::group(['middleware' => ['auth:admin', 'verified']], function () {
            ...
            Route::resource('assignAll', AssignPenilaiAllController::class);
            Route::get('request_download_excel', [SurveyController::class, 'export'])->name('request_download_excel');
        });
    });
});
