<div id="kt_aside" class="aside bg-primary" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="auto" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_toggle">
    <!--begin::Logo-->
    <div class="aside-logo d-none d-lg-flex flex-column align-items-center flex-column-auto py-8" id="kt_aside_logo" style="background-color: #0984E3">
        <a href="index.html">
            <img alt="Logo" src="{{asset('img/logo.png')}}" class="h-30px" style="background-color: white"/>
        </a>
    </div>
    <!--end::Logo-->
    <!--begin::Nav-->
    <div class="aside-nav d-flex flex-column align-lg-center flex-column-fluid w-100 pt-5 pt-lg-0" id="kt_aside_nav" style="background-color: #0984E3">
        <!--begin::Primary menu-->
        <div id="kt_aside_menu" class="menu menu-column menu-title-gray-600 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-bold fs-6" data-kt-menu="true">
            ...
            <div data-kt-menu-trigger="click" data-kt-menu-placement="right-start" data-kt-menu-flip="bottom" class="menu-item py-2">
                ...
                <div class="menu-sub menu-sub-dropdown w-225px px-1 py-4">
                    ...
                    <div class="menu-item">
                        <a class="menu-link {{request()->is('admin/survey') ? 'active' : ''}}" href="{{route('admin.survey.index')}}">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                            <span class="menu-title">Lihat Hasil Penilaian</span>
                        </a>
                    </div>
                </div>
            </div>
            ...
            @elseif($role == "s")
            <div data-kt-menu-trigger="click" data-kt-menu-placement="right-start" data-kt-menu-flip="bottom" class="menu-item py-2">
                <span class="menu-link {{request()->is('staff/kelolapenilaian') || request()->is('staff/assignpenilai') ? 'active' : ''}} menu-center" title="Data Master" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                    <span class="menu-icon me-0">
                        <i class="bi bi-shield-check fs-2"></i>
                    </span>
                </span>
                <div class="menu-sub menu-sub-dropdown w-225px px-1 py-4">
                    ...
                    <div class="menu-item">
                        <a class="menu-link {{request()->is('staff/datapenilaian') ? 'active' : ''}}" href="{{route('staff.assign-penilai.index')}}">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                    ...
                    {{-- <div class="menu-item">
                        <a class="menu-link {{request()->is('staff/survey') ? 'active' : ''}}" href="{{route('staff.survey.index')}}">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                            <span class="menu-title">Lihat Hasil Penilaian</span>
            ...
            @elseif($role == "m")
            <div data-kt-menu-trigger="click" data-kt-menu-placement="right-start" data-kt-menu-flip="bottom" class="menu-item py-2">
                <span class="menu-link {{request()->is('mahasiswa/kelolapenilaian') || request()->is('mahasiswa/assignpenilai') ? 'active' : ''}} menu-center" title="Data Master" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                    <span class="menu-icon me-0">
                        <i class="bi bi-shield-check fs-2"></i>
                    </span>
                </span>
                <div class="menu-sub menu-sub-dropdown w-225px px-1 py-4">
                    ...
                    <div class="menu-item">
                        <a class="menu-link {{request()->is('mahasiswa/datapenilaian') ? 'active' : ''}}" href="{{route('siswa.assign-penilai.index')}}">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                            <span class="menu-title">Data Penilaian</span>
